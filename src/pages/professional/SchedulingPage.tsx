              ...
              <div className="space-y-6">
                ...
                <div className="bg-gray-50 p-4 rounded-lg">
                  ...
                  <p className="text-sm text-gray-600 mt-1">
                    O paciente não pode ser alterado. Para trocar o paciente, cancele esta consulta e crie uma nova.
                  </p>
                </div>
